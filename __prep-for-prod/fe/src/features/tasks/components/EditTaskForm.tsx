...
export default function EditTaskForm({ id, onUpdated }: Props) {
  ...
  const { register, handleSubmit, reset, setValue, formState: { errors, isValid, isSubmitting } } =
    useForm<TaskFormData>({ resolver: zodResolver(TaskSchema), mode: 'onChange' })
  ...
  if (loading) return <p>Loading task for edit...</p>
